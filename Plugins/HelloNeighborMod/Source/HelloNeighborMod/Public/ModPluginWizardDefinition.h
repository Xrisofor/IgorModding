...
public:
	...
	virtual FString GetPluginFolderPath() const override { return GetFolderForTemplate(CurrentTemplateDefinition.ToSharedRef()); };
...
private:
	...
	FString GetFolderForTemplate(TSharedRef<FPluginTemplateDescription> InTemplate) const { return InTemplate->OnDiskPath; };
